...
The authoritative trading rules remain in `system/ETF规则_MASTER.md`. This repository does not place API keys in files, does not generate trade recommendations, does not modify the MASTER, and does not place orders.
