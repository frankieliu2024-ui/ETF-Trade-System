...
class ReportDeliveryContractTests(unittest.TestCase):
    def _request(self):
        body = "# ETF日复盘\n\n已完成的正式报告。"
        return {
            "schema_version": "1.0", "channel": "REPORT", "report_type": "ETF_TRADE_REVIEW",
            "report_id": "review-20260903", "task_id": "etf-trade-review", "task_run_id": "run-20260903",
            "generated_at": "2026-09-03T22:00:00+08:00", "effective_market_date": "2026-09-03",
            "source_actor": "ChatGPT", "source_reference": "product-task:ETF交易复盘",
            "title": "【交易复盘】ETF日复盘｜2026-09-03", "summary": "正式收盘复盘已完成",
    ...
    def test_existing_events_default_to_interrupt_compact(self):
        item = notification_center.normalize_notification({"key": "market:1", "event_type": "SYSTEM_EVENT", "title": "test", "content": "test"})
