...
class TencentHistoryTest(unittest.TestCase):
    ...
    def test_pages_backwards_without_duplicate_dates(self):
        page_1 = {
            "code": 0,
            "data": {
                "sh510300": {
                    "day": [
                        ["2026-09-10", "4.1", "4.2", "4.3", "4.0", "100"],
                        ["2026-09-11", "4.2", "4.3", "4.4", "4.1", "110"],
                    ]
                }
            },
        }
        page_2 = {
            ...
            "data": {
                "sh510300": {
                    "day": [
                        ["2026-09-08", "3.9", "4.0", "4.1", "3.8", "90"],
                        ["2026-09-09", "4.0", "4.1", "4.2", "3.9", "95"],
                    ]
                }
            },
        }
        with mock.patch(
            "scripts.tencent_quote.urllib.request.urlopen",
            side_effect=[_Response(json.dumps(page_1)), _Response(json.dumps(page_2))],
        ) as mocked:
            rows, meta = fetch_tencent_daily_history(
                "510300.SH", "2026-09-08", "2026-09-11", page_size=2
            )
