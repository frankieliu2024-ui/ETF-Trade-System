...
class SettlementObligationTests(unittest.TestCase):
    ...
    def test_numeric_formatting_does_not_split_same_economic_obligation(self):
        pending = ipo("PENDING_PAYMENT")
        pending["quantity"] = 500
        pending["subscription_price"] = 16
        pending["required_cash"] = 8000
        settled = ipo("SETTLED")
        settled["quantity"] = 500.0
        settled["subscription_price"] = 16.0
        settled["required_cash"] = 8000.0
