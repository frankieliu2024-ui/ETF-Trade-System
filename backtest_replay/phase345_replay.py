...
def load_fixture(root: Path) -> dict:
    fixture = root / "replay_sources" / "market_fixture_2026-08-21.json"
...
def write_account_and_dashboard(root: Path, source_root: Path) -> None:
    ...
    shutil.copy2(source_root / "system" / "ETF当前状态_DASHBOARD.md", root / "system" / "ETF当前状态_DASHBOARD.md")
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory() as temp:
        ...
        out = root / "backtest_replay" / "phase345_replay_result.json"
