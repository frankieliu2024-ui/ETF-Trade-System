...
def build_decision_fact_pack(root: Path, request: dict, current: dict, account: dict, decision: dict, market_quote: dict, formal_discovery: dict | None = None) -> dict:
    ...
    return {
        ...
        "user_visible_reply_boundary": {
            ...
            "compression_rule": "Compress unchanged evidence, not business conclusions. Every actual holding remains individually visible. Three-layer monitoring is summarized by decision-changing deltas rather than raw data dumping.",
