...
def main() -> int:
    ...
    research_contract_proc = subprocess.run([os.environ.get("PYTHON", "python"), "-m", "unittest", "tests.test_research_artifact_contract"], cwd=ROOT, capture_output=True, text=True, encoding="utf-8", errors="replace", check=False)
