...
def sync_experience_transaction_index(event: dict) -> None:
    ...
    # Human projection renders 名称（代码） exactly once. Historical backfill
    # manifests may already carry the display-form name.
    ...
    # Economic execution identity is execution-time based. Canonical adoption
    # time is metadata and must never create a second human transaction row.
