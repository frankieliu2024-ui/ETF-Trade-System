...
def main() -> int:
    ...
    schedule_blocked = os.environ.get("GITHUB_EVENT_NAME") == "schedule" and not pulse["refresh_eligible"]
    ...
    if pulse["natural_pulse_identity_status"] == "AMBIGUOUS":
        warnings.append("ambiguous_scheduled_pulse: occurrence identity unavailable; current refresh is not natural-pulse fulfillment")
    if schedule_blocked:
        warnings.append(f"stale_scheduled_pulse: {pulse['latest_candidate_slot_at'] or pulse['scheduled_cron']}")
    ...
    report = {
        ...
        "natural_pulse_identity_status": pulse["natural_pulse_identity_status"],
        "latest_candidate_slot_at": pulse["latest_candidate_slot_at"],
        "candidate_delay_seconds": pulse["candidate_delay_seconds"],
        "candidate_delay_class": pulse["candidate_delay_class"],
        "natural_pulse_eligible": pulse["natural_pulse_eligible"],
